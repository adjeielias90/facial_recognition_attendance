    ...
    return (
        <section>
            ...
            <AddEmployeeForm>
                ...
                { isUserWellAdded && <SuccessAddUser>User added to the Database!</SuccessAddUser> }
                { errorWhileAddingUser && <ConstErrorAddUser>User was not added to the Database. Please try again...</ConstErrorAddUser> }
            </AddEmployeeForm>
        </section>
    );
};
